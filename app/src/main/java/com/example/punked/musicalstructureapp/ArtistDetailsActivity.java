...
/**This activity displays and plays the songs of the chosen artist only*/
public class ArtistDetailsActivity extends AppCompatActivity {
    private ArrayList<Song> songArrayList = new ArrayList<Song>();
    private SongDB songDB;
    private String artistSearched;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        artistSearched = intent.getStringExtra("artistName");
        songArrayList = songDB.getSongsByArtist(artistSearched);
        ...
        /**Since selecitng a song starts auto play we need to provide the functionality to the button itself*/

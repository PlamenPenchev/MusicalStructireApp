...
/**This Activity holds the main track list. It displays all the songs present in the app and provides
 * options to play, pause, go to next song etc.*/
